...
certbot certonly --manual -d *.backyello.stiip.it --email supporto@stiip.it --agree-tos --manual-public-ip-logging-ok --preferred-challenges dns-01 --server https://acme-v02.api.letsencrypt.org/directory
